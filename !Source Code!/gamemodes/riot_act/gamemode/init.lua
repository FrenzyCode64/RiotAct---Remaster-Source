...
local RandomPerson = math.random(1, 8)
...
if (RandomPerson == 3) then
ply:SetModel( "models/player/group01/male_03.mdl" )
end

if (RandomPerson == 4) then
ply:SetModel( "models/player/group01/male_04.mdl" )
end

if (RandomPerson == 5) then
ply:SetModel( "models/player/group01/frmale_01.mdl" )
end

if (RandomPerson == 6) then
ply:SetModel( "models/player/group01/frmale_02.mdl" )
end

if (RandomPerson == 7) then
ply:SetModel( "models/player/group01/female_03.mdl" )
end

if (RandomPerson == 8) then
